                ...
                <div class="card-body">
                        ...
                        <div class="m-2 text-center">
                                <span class="fa-stack text-success fa-3x">
                                        ...
                                        <p class="h3 font-weight-bold mt-2">Create Account</p>
                                    </div>
                        <br>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" placeholder="Email " class="form-control p-4 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
