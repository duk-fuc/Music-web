    ...
    <section class="oneMusic-buy-now-area has-fluid bg-gray section-padding-100">
       <div class="container">
        <div class="row">
                ...
                <p>
                        <a href="{{url('savemusic/'.$song->id)}}" class="btn btn-xs oneMusic-btn btn-2">Save to device</a>
                </p>
...
<div class="row">
        ...
        <div class="mt-5"> 
                <iframe width="100%" height="500" src="https://www.youtube.com/embed/{{$song->video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
