...
<li class="nav-item"><a class="nav-link {{Request::path()=="admin/musics" ? 'active' : ''}}" href="/admin/musics"><em class="fas fa-music"></em> Song</a></li>
...
<li class="nav-item"><a class="nav-link {{Request::path()=="admin/events" ? 'active' : ''}}" href="/admin/events"><em class="fas fa-calendar"></em> Event</a></li>
