            ...
            <table class="table table-striped">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Album Contents</th>
            ...
            <div class="modal-body">
                ...
                <form id="editform">
                    ...
                    <div class="form-group">
                        ...
                        <label for="image">Photo Album</label>
    ...
    $('#editform').submit(function(e) {
        ...
        $.ajax({
            ...
            error: function(result) {
                ...
                toastr.error('Can not edit music', 'Error! An error occurred. Please try again later!');
            }
        });
    });
...
$('#albumform').submit(function(e) {
    ...
    $.ajax({
        ...
        error: function(result) {
            ...
            toastr.error('Can not add album', 'Error! An error occurred. Please try again later!');
        }
    });
});
//delete album
