...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12">
                    ...
                    <div class="col-xl-3 col-md-3 mb-3">
                      <div class="card rounded-o text-white bg-primary o-hidden h-100">
                        <div class="card-body">
                          ...
                          <div class="mr-5">Having {{ App\Music::count() }} Song</div>
                        </div>
                    <a class="card-footer text-white clearfix small z-1" href="{{route('music')}}">
                          <span class="float-left">See details!</span>
                    ...
                    <div class="col-xl-3 col-md-3 mb-3">
                      <div class="card rounded-0 bg-primary text-white o-hidden h-100">
                        <div class="card-body">
                          ...
                          <div class="mr-5">Having {{ App\Album::count() }} Albums</div>
                        </div>
            ...
            <!--end of cards-->
            <h3 class="my-4 font-weight-bold">New song</h3><hr>
<div class="row">
