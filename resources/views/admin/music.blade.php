            ...
            <div class="modal-body">
                    <div id="msgs" class="msgs">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="video" id="video" class="form-control" rows="5" required></textarea>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            <p><small class="text-muted">Leave blank if you're a singer</small></p>
                                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <p><small class="text-muted">You can only add files <b>.mp3</b> </small></p>
...
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="exampleModalLongTitle">More songs</h5>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
...
<label for="image">Song photo</label>
...
<div class="form-group">
    ...
    <p><small class="text-muted">Only files can be added <b>.mp3</b></small></p>
...
$('#msgs').append(msgs);
   ...
   toastr.error('Network connection error', 'Error! An error occurred. Please try again later!');
			}
		});
    });
...
$('#msgs').append(msgs);
   ...
   toastr.error('Can not add music', 'Error! An error occurred. Please try again later!');
			}
		});
    });
